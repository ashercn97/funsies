// DO NOT EDIT: Code generated by matcha from by_id.matcha
...
pub fn by_id(db: pgo.Connection, id: Int) -> Result(")
    let builder = string_builder.append(builder, table.name)
    let builder = string_builder.append(builder, ".")
  ...
  let query = \"SELECT * FROM ")
    let builder = string_builder.append(builder, table.name)
    let builder = string_builder.append(builder, " WHERE id = $1\"
  pgo.execute(db, [pgo.int(id)], ")
    let builder = string_builder.append(builder, table.name)
    let builder = string_builder.append(builder, ".")
    let builder = string_builder.append(builder, table.name)
